...
/* 
1 - исполнение идет слева направо. значения сравниваются попарно. 
2 - если оба значения числа - выполняем сложение чисел. 
3 - В случае сложения числа и строки - число преобразуется в строку и склеиваются 2 строки 
